...
export interface ApiComentaryComentary extends Struct.CollectionTypeSchema {
...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    prep_time: Schema.Attribute.Integer & Schema.Attribute.Required;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    reviews: Schema.Attribute.Relation<'oneToMany', 'api::review.review'>;
    images_recipes: Schema.Attribute.Media<'images', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    images_tags: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::comentary.comentary': ApiComentaryComentary;
